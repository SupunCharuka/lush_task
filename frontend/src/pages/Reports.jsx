  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      <header className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-3xl font-semibold">Analytics & Reports</h2>
          <p className="text-sm text-gray-600">Download income/expense statements and view quick summaries.</p>
        </div>
      </header>
      ...
      <section className="mb-6 grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="p-4 bg-white border rounded shadow-sm">
          ...
          <div className="text-2xl font-bold">${totals.expense.toFixed(2)}</div>
        </div>
        <div className={`p-4 border rounded shadow-sm ${totals.net>=0? 'bg-green-50':'bg-red-50'}`}>
      ...
      <section className="mb-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <aside className="bg-white border rounded p-4">
          ...
          <div className="mb-4">
            ...
            <select value={format} onChange={e=>setFormat(e.target.value)} className="w-full rounded border p-2">
      ...
      <section className="bg-white border rounded p-4">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="text-sm text-gray-500">Showing up to 20 items</div>
        </div>
